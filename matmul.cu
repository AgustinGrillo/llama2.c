...
// Kernel launcher
void cuda_kernels::mmult_naive(float *out, float *a, float *b, int m, int k,
                               int n) {
...
// Kernel
void cuda_kernels::mmult_cublas(cublasHandle_t cublas_handle, float *out,
                                float *a, float *b, int m, int k, int n) {
