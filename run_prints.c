...
void print_first_and_last(float *x, int dim) {
  for (int i = 0; i < 5; i++) {
    printf("%f ", x[i]);
  }
  printf("... ");
...
float *forward(Transformer *transformer, int token, int pos) {
  ...
  for (unsigned long long l = 0; l < p->n_layers; l++) {
    ...
    printf("Attention rmsnorm weights: ");
    print_first_and_last(w->rms_att_weight + l * dim, dim);
    printf("Attention rmsnorm: ");
    print_first_and_last(s->xb, dim);
    ...
    printf("Q: ");
    print_first_and_last(s->q, 1 * dim);
    printf("K: ");
    print_first_and_last(s->k, 1 * kv_dim);
    printf("V: ");
    print_first_and_last(s->v, 1 * kv_dim);
    ...
    printf("K cache: ");
    print_first_and_last(s->key_cache + loff, pos * kv_dim);
    printf("V cache: ");
    print_first_and_last(s->value_cache + loff, pos * kv_dim);
...
#pragma omp parallel for private(h)
    ...
    printf("Attention Mmult wo: ");
    print_first_and_last(w->wo + l * dim * dim, dim * dim);
    printf("Attention Mmult: ");
    print_first_and_last(s->xb2, dim);
    ...
    printf("FFN rmsnorm weights: ");
    print_first_and_last(w->rms_ffn_weight + l * dim, dim);
    printf("FFN rmsnorm: ");
    print_first_and_last(s->xb, dim);
    ...
    printf("FFN w1: ");
    print_first_and_last(s->hb, hidden_dim);
    printf("FFN w3: ");
    print_first_and_last(s->hb2, hidden_dim);
  ...
  printf("\nRmsnorm weights: ");
  print_first_and_last(w->rms_final_weight, dim);
  printf("Rmsnorm: ");
  print_first_and_last(x, dim);

  // classifier into logits
  matmul(s->logits, x, w->wcls, p->dim, p->vocab_size);
  printf("Logits weigths: ");
  print_first_and_last(w->wcls, p->dim * p->vocab_size);
  printf("Logits: ");
  print_first_and_last(s->logits, p->vocab_size);
